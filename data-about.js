...
function generateAboutPage() {
    ...
    <div class="stat-card" style="margin:2rem 0;"><strong>📧 Contact:</strong> @eolvvin<br>🌌 Zenodo: <a href="https://zenodo.org/communities/emergence" target="_blank" style="color:cyan">community/emergence</a><br>📚 All preprints open access.</div>`;
}
