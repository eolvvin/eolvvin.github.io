...
function generateFrameworkPage() {
    ...
    <div class="simulation-grid">
        <div class="volume-block">
            ...
            <p>${crt ? 'Binary search converging to the internal lattice parameter β = 1.868164, plus a 1+1D simulation demonstrating bound state formation from colliding wave packets at threshold R = 4.0.' : 'Binary search converging to the internal lattice parameter β = 1.868164, plus a 1+1D simulation demonstrating bound state formation from colliding wave packets at threshold R = 4.0.'}</p>
    ...
    <table class="data-table">
        ...
        <tbody>
            <tr><td>${crt ? 'BETA FINDER' : 'Beta Finder'}</td><td>—</td><td>β = 1.868164</td></tr>
