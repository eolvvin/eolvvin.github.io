...
function generateHome() {
    ...
    if (crt) {
        ...
        <div class="hero-sub">&gt;&gt; THEORY OF EVERYTHING &lt;&lt;</div>
        ...
        <div style="max-width:800px;margin:1.5rem auto 2.5rem;padding:1.2rem 1.5rem;background:#030803;border:1px solid #00cc33;text-align:center;">
            ...
            <div style="font-family:'Share Tech Mono',monospace;font-size:0.82rem;color:#00cc33;line-height:1.8;">
                &gt; <a href="https://doi.org/10.5281/zenodo.21327996" target="_blank" rel="noopener noreferrer" style="color:#00ff41;text-decoration:none;border-bottom:1px solid rgba(0,255,65,0.3);">THEORY OF EVERYTHING</a> — Complete paper (all seven parts)
            </div>
    ...
    return `<div class="hero"><h1>Emergence Canvas Model<br>Unified Framework</h1><div class="hero-sub">Theory of Everything</div>
    ...
    <div style="max-width:800px;margin:1.5rem auto 2.5rem;padding:1.5rem 2rem;background:rgba(8,8,22,0.65);border-radius:18px;border:1px solid rgba(136,204,255,0.4);text-align:center;backdrop-filter:blur(8px);">
        ...
        <div style="font-size:0.95rem;color:var(--text-dim);line-height:2;">
            <a href="https://doi.org/10.5281/zenodo.21327996" target="_blank" rel="noopener noreferrer" style="color:var(--accent-cyan);text-decoration:none;border-bottom:1px dotted rgba(136,204,255,0.4);">Theory of Everything</a> — Complete paper (all seven parts)
        </div>
