...
const knownNumbers = [
    ...
    { name: "Internal lattice parameter", predicted: "β = 0.167 ± 0.005", observed: "Derived", dependencies: "III" },
    ...
    { name: "Cosmological constant", predicted: "Ω_Λ = 3/(3+√2)(1+α₀) ≈ 0.685", observed: "Ω_Λ ≈ 0.685 ± 0.007", dependencies: "P6, II" },
    ...
    { name: "Scalar spectral index", predicted: "n_s ≈ 0.964", observed: "n_s ≈ 0.9649 ± 0.0042", dependencies: "P2, P6, II" },
    { name: "Tensor-to-scalar ratio", predicted: "r ≪ 0.01", observed: "r < 0.036 (95% CL)", dependencies: "P2, P6, II" },
    { name: "Spectral index running", predicted: "α_s ≈ -6.6 × 10⁻⁴", observed: "α_s ≈ -0.0045 ± 0.0067", dependencies: "P2, P6, II" },
    { name: "Non-Gaussianity", predicted: "f_NL^local ∼ 0.02", observed: "f_NL ≈ -0.9 ± 5.1", dependencies: "P2, P6, II" },
    { name: "Baryon asymmetry", predicted: "η ∼ 10⁻⁹", observed: "η ≈ 6.1 × 10⁻¹⁰", dependencies: "P5, P7, P6, II" },
    { name: "Dark matter abundance", predicted: "Ω_DM ∼ 0.26 (boundary condition)", observed: "Ω_DM ≈ 0.26", dependencies: "P2, P6, II" },
    { name: "Strong CP angle", predicted: "θ_QCD = 0 (exact)", observed: "θ_QCD < 10⁻¹⁰", dependencies: "P6, II" },
    { name: "CKM λ (base)", predicted: "1/5 = 0.2", observed: "λ ≈ 0.2245 ± 0.0008", dependencies: "P8" },
    { name: "CKM λ (full diagonalization)", predicted: "0.225", observed: "λ ≈ 0.2245 ± 0.0008", dependencies: "P5, P7, P8" },
    { name: "CKM V_us", predicted: "0.225", observed: "0.2245 ± 0.0008", dependencies: "P6, P8, III" },
    { name: "CKM V_cb", predicted: "0.041", observed: "0.0408 ± 0.0014", dependencies: "P6, P8, III" },
    { name: "CKM V_ub", predicted: "λ³ · 1/3 ≈ 0.0036", observed: "0.00361 ± 0.00030", dependencies: "P6, P8, III" },
    { name: "Jarlskog invariant", predicted: "J ≈ 3.05 × 10⁻⁵", observed: "J ≈ (3.00 ± 0.09) × 10⁻⁵", dependencies: "P5, P7, P8" },
    { name: "PMNS θ₁₂", predicted: "1/√3 ≈ 33.1°", observed: "33.4° ± 0.7°", dependencies: "P8" },
    ...
    { name: "Gauge threshold hierarchy", predicted: "T_ST < T_SU(3) < T_SU(2) < T_U(1)", observed: "Derived", dependencies: "P8, II" },
    ...
    { name: "Electron mass", predicted: "m_e ≈ 0.511 MeV (exact integral)", observed: "m_e ≈ 0.5110 ± 0.0001 MeV", dependencies: "P2, P8, III" },
    ...
    { name: "Weak mixing angle", predicted: "sin²θ_W ≈ 0.231", observed: "sin²θ_W ≈ 0.2312 ± 0.0002", dependencies: "P8, III" },
    ...
    { name: "Higgs VEV", predicted: "v ≈ 245 GeV", observed: "v ≈ 246 GeV", dependencies: "P8, III" },
    { name: "Top quark mass", predicted: "m_t ≈ 172.5 GeV (computed)", observed: "m_t ≈ 172.5 ± 0.7 GeV", dependencies: "P2, P8, III" },
    { name: "Bottom quark mass", predicted: "m_b ≈ 4.18 GeV", observed: "m_b ≈ 4.18 ± 0.03 GeV", dependencies: "P2, P8, III" },
    { name: "Charm quark mass", predicted: "m_c ≈ 1.27 GeV", observed: "m_c ≈ 1.27 ± 0.02 GeV", dependencies: "P2, P8, III" },
    { name: "Strange quark mass", predicted: "m_s ≈ 93.1 MeV", observed: "m_s ≈ 93.4 ± 8.6 MeV", dependencies: "P2, P8, III" },
    { name: "Up quark mass", predicted: "m_u ≈ 1.74 MeV (harmonic), ≈ 2.0 MeV (exact integral)", observed: "m_u = 2.16 ± 0.26 MeV", dependencies: "P2, P8, III" },
    { name: "Down quark mass", predicted: "m_d ≈ 4.67 MeV", observed: "m_d ≈ 4.67 ± 0.32 MeV", dependencies: "P2, P8, III" },
    { name: "Tau mass", predicted: "m_τ ≈ 1.78 GeV", observed: "m_τ ≈ 1.777 ± 0.002 GeV", dependencies: "P2, P8, III" },
    { name: "Muon mass", predicted: "m_μ ≈ 0.106 GeV", observed: "m_μ ≈ 0.1057 ± 0.0001 GeV", dependencies: "P2, P8, III" },
    { name: "Solar neutrino splitting", predicted: "Δm²₂₁ ≈ 7.5 × 10⁻⁵ eV²", observed: "Δm²₂₁ ≈ (7.53 ± 0.18) × 10⁻⁵ eV²", dependencies: "P8, III" },
    { name: "Atmospheric neutrino splitting", predicted: "Δm²₃₂ ≈ 2.5 × 10⁻³ eV²", observed: "Δm²₃₂ ≈ (2.45 ± 0.03) × 10⁻³ eV²", dependencies: "P8, III" },
    { name: "CKM CP phase", predicted: "δ ≈ 68°", observed: "δ ≈ 68° ± 4°", dependencies: "P5, P8, III, IV" },
    { name: "PMNS CP phase", predicted: "δ_CP = π(1+α) ≈ 220°", observed: "∼ 230° (hint)", dependencies: "P5, P8, III, IV" },
    { name: "Baryon density", predicted: "Ω_B ≈ 0.05", observed: "Ω_B ≈ 0.05", dependencies: "II, IV" },
    { name: "Hubble constant", predicted: "H₀ ≈ 67.4 km/s/Mpc (boundary condition)", observed: "H₀ ≈ 67.4 km/s/Mpc", dependencies: "II" },
    ...
    { name: "GUT scale (non-unification)", predicted: "No unification; gauge ratios fixed at M_P", observed: "Consistent with non-unification", dependencies: "P8, III" }
];
...
const unknownPredictions = [
    ...
    { name: "Neutrino mass ordering", predicted: "Inverted (m₁ > m₃ > m₂)", observed: "Pending (JUNO, DUNE)", dependencies: "P8, III" },
    { name: "Neutrinoless double beta decay", predicted: "⟨m_ββ⟩ ≈ 0.035 eV", observed: "Not yet observed", dependencies: "P8, III" },
    ...
    { name: "Right-handed neutrino mass", predicted: "M_R = M_P · α₀² ≈ 1.5 × 10¹⁴ GeV", observed: "Not yet observed", dependencies: "P8, III" },
    { name: "PBH formation fraction", predicted: "β ∼ 0.085", observed: "Consistent", dependencies: "II, IV" },
    { name: "Axion mass (if axion exists)", predicted: "m_a ∼ 10⁻⁵ eV (but axion not required)", observed: "Not yet observed", dependencies: "P6, II" },
    { name: "Reheating temperature", predicted: "T_reh ∼ T_P", observed: "Not yet measured", dependencies: "II" },
    { name: "Gauge coupling non-unification", predicted: "g₁² : g₂² : g₃² = 1 : 2/3 : 2/π at M_P", observed: "Consistent with data", dependencies: "P8, III" },
